...
<x-layout title="ゆでたまごタイマー | cooking">
        ...
        <section class="feature">
            <div class="feature-item">
                <img src="{{ $imgPath }}" alt="{{ $eggName }}">
                <h2 class="feature-desc">{{ $eggName }}</h2>
            </div>
            <div class="feature-cookinginfo">
                <input type="hidden" value="{{ $boilMiliSec }}">
                <p>ゆで時間</p>
                <p><strong>
                    <span class="disp-min"></span>分<span class="disp-sec"></span>秒
                </strong></p>
            </div>
        </section>
        ...
        <section class="recipe container">
            <div class="recipe-note">
                <p>以下の手順に従って調理し、<br>タイマーをスタートして下さい<br>↓↓↓</p>
            </div>
            <p class="recipe-top">調理手順（全５手順）</p>
            <div class="recipe-contents">
                <div class="recipe-item">
                    <ol>
                        <li>鍋に水をたっぷり入れる（卵全体がしっかりと浸かるくらい）</li>
                    </ol>
                    <img src="https://placehold.jp/180x160.png" alt="調理画像">
                </div>
                <div class="recipe-item">
                    <ol>
                ...
                <div class="recipe-item" style="border-bottom: rgba(217, 217, 217, .6) 8px solid;">
                ...
                <!-- <p style="text-align: center; font-size: 1.2rem; margin: 40px 0 90px;">タイマーが鳴ったら、ゆでたまごの完成です！</p> -->
                <button type="button" id="btn-confirm">タイマー<br>スタート</button>
            </div>
        </section>

        <section id="modal-cooking">
            <div class="btn-container">
            <p>別ページに移動し、タイマーが自動でスタートします。</p>
                <!-- <form action="{{ route('timer.index') }}" action="POST">
                    @csrf
                    <input type="hidden" value="{{ $boilMiliSec }}">
                    <button type="button" class="btn-back" style="color: skyblue">戻る</button>
                    <button type="submit" class="btn-next" style="color: skyblue">OK!</button>
                </form> -->
                    <a href="{{ route('home.index') }}">戻る</a>
                    <a href="{{ route('timer.index') }}">OK!</a>
            </div>
        </section>
        <div id="mask-cooking"></div>
</x-layout>
